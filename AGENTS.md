...
This is a standalone, experimental dotfiles-OpenWrt repository. Support priority is
...
- netrun changes only child environment; never print proxy credentials, change router_proxy or rewrite firewall/rules. Shell sessions are child shells; exit restores the parent.
...
- Source provenance: RPi-ImmortalWrt is a reference; firmware and device operations remain there.
