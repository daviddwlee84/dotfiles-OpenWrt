...
Long-term backlog for dotfiles-OpenWrt. See AGENTS.md
...
- [ ] **[?/M] Validate Pi workflows and evaluate additional development tools** — Measure Herdr, SpecStory and Codex on the 1 GB Pi; evaluate fzf, lazygit, gh, Neovim and Node/npm only after the baseline. → [research](backlog/validate-pi-workflows-and-evaluate-additional-development-tools.md)
